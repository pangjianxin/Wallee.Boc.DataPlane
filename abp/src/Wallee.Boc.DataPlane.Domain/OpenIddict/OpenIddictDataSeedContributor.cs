...
namespace Wallee.Boc.DataPlane.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("DataPlane") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "DataPlane", DisplayName = "DataPlane API", Resources = { "DataPlane" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        {
            var consoleAndAngularClientRootUrl = configurationSection["DataPlane_App:RootUrl"]?.TrimEnd('/');
            await CreateApplicationAsync(
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["DataPlane_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["DataPlane_Swagger:RootUrl"]?.TrimEnd('/');
